...
def gen_report(report_data, analysis):
    """Genera el documento Word con el reporte preliminar de la calidad del agua, a partir del análisis de las variables
    realizado en el módulo analyzer"""
    doc = Document()
    ...
    h_run.add_picture('webapp/static/img/logo.png', width=Cm(1.5))
    ...
    doc.add_paragraph(
        'Es posible decir entonces que el ' + str(analysis['F']['% Cumplimiento Total'][1]) + '% del agua, tiene una alta probabilidad de ser potable.')
